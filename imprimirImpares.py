print('Crear una aplicacion que imprima todos los numeros impares que existen entre un rango de numeros proporiconados por el usuario, usandp el ciclo while')

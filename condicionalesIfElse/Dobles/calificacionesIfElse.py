print('Crear la aplicación y el diagrama de flujo que permita lea 8 calificaciones y genere el promedio y este es mayor a 8 muestre el mensaje aprobado de lo contrario indicar reprobado. ')
...
sumar = calificaciones1 + calificaciones2 + calificaciones3 + calificaciones4 + calificaciones5 + calificaciones6 + calificaciones7 + calificaciones8

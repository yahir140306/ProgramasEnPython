...
class AplicacionTareas:
    ...
    def crear_elementos(self):
        ...
        tk.Label(marco_entrada, text="Nueva tarea:", font=("Arial", 10), bg='#f0f0f0').pack(anchor='w')
        ...
        tk.Button(marco_entrada, text="Agregar Tarea",
                  command=self.agregar_tarea, bg="#4CAF50", fg="white").pack(side="left", padx=5)
